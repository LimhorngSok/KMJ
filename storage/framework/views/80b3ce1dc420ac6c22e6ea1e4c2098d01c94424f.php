<section id="schedule-content">
  <div class="container tab-content">
    <div class="tab-pane fade show active" id="tap1">
      <?php echo $__env->make('demo.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="tab-pane fade" id="tap2">
      <?php echo $__env->make('demo.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="tab-pane fade" id="Jul5">
      <?php echo $__env->make('demo.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php /**PATH /home/k-linux/myapp/KMJ/resources/views/Layout/Schedule/schedule-tap.blade.php ENDPATH**/ ?>