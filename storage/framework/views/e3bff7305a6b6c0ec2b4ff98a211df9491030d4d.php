      ...
      <ul class="sidebar-menu">
       ...
       <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class=""><a href="<?php echo e(route('bloguser.index')); ?>"><i class="fa fa-circle-o"></i>Users</a></li>
        </ul>
      </li>
       <li class="treeview">
        <a href="#">
...
<?php /**PATH /home/k-linux/myapp/KMJ/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>