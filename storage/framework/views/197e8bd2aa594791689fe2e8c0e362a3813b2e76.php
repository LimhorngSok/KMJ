      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo e(route('bloguser.update',$user->id)); ?>" method="post">
            ...
            <?php echo e(method_field('PUT')); ?>
              ...
              <div class="form-group">
                ...
                <a href='<?php echo e(route('bloguser.index')); ?>' class="btn btn-warning">Back</a>
              </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/k-linux/myapp/KMJ/resources/views/admin/bloguser/edit.blade.php ENDPATH**/ ?>