  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <a class='col-lg-offset-5 btn btn-success' href="<?php echo e(route('permission.create')); ?>">Add New</a>
                        ...
                        <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            ...
                            <td><?php echo e($permission->for); ?></td>
                              <td><a href="<?php echo e(route('permission.edit',$permission->id)); ?>"><span class="glyphicon glyphicon-edit"></span></a></td>
                              <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/k-linux/Downloads/kak/resources/views/admin/permission/show.blade.php ENDPATH**/ ?>