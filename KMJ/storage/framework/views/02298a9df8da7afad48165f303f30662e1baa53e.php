...
<?php $__env->startSection('main-content'); ?>
	...
	<div class="col-lg-8">
		...
		<div class="col blog">
	    <a href="<?php echo e($post->slug); ?>"><img id="img" class="img-fluid" src="<?php echo e(Storage::disk('local')->url($post->image)); ?>" alt=""></a>
...
<?php echo $__env->make('user/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/horng/Desktop/KMJ/KMJ/resources/views//user/blog.blade.php ENDPATH**/ ?>