...
<section id="blog">
  ...
  <div class="container">
    <div class="row">
      <?php echo $__env->make('user/blog', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
  </div>
</section>
<?php echo $__env->make('Layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /home/k-linux/myapp/kak/resources/views/Blog.blade.php ENDPATH**/ ?>